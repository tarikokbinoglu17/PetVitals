...
> = {
  tr: {
    ...
    disclaimer: "Faunvia AI eğitim amaçlı destek sunar; veteriner tanısının yerini tutmaz.",
  ...
  en: {
    ...
    disclaimer: "Faunvia AI provides educational support, not a veterinary diagnosis.",
  ...
  de: {
    ...
    disclaimer: "Faunvia AI bietet Informationen und ersetzt keine tierärztliche Diagnose.",
    languageName: "German",
  },
  es: {
    ...
    disclaimer: "Faunvia AI ofrece información educativa y no sustituye un diagnóstico veterinario.",
  ...
  ja: {
    ...
    disclaimer: "Faunvia AIは情報提供を目的としており、獣医師の診断に代わるものではありません。",
