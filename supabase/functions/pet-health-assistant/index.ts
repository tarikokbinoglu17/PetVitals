...
> = {
  tr: {
    ...
    disclaimer: "PetCookieGo AI eğitim amaçlı destek sunar; veteriner tanısının yerini tutmaz.",
  ...
  en: {
    ...
    disclaimer: "PetCookieGo AI provides educational support, not a veterinary diagnosis.",
  ...
  de: {
    ...
    disclaimer: "PetCookieGo AI bietet Informationen und ersetzt keine tierärztliche Diagnose.",
    languageName: "German",
  },
  es: {
    ...
    disclaimer: "PetCookieGo AI ofrece información educativa y no sustituye un diagnóstico veterinario.",
  ...
  ja: {
    ...
    disclaimer: "PetCookieGo AIは情報提供を目的としており、獣医師の診断に代わるものではありません。",
