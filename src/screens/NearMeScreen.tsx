...
const C = {
  tr: {
    ...
    hello: "Merhaba, PetCookieGo üzerinden randevu talep ediyorum.",
  },
  en: {
    title: "Care near you",
    ...
    hello: "Hello, I am requesting an appointment through PetCookieGo.",
  },
  de: {
    ...
    hello: "Hallo, ich möchte über PetCookieGo einen Termin anfragen.",
  },
  es: {
    ...
    hello: "Hola, solicito una cita a través de PetCookieGo.",
  },
  ja: {
    title: "周辺のケア施設",
...
export function NearMeScreen({
  ...
  return (
    <View style={styles.page}>
      <Text style={styles.eyebrow}>PETCOOKIEGO NEARBY</Text>
