...
const copy = {
  ...
  en: {
    ...
    deleteBody:
      "Your PetVitals account and related data will be deleted permanently. This cannot be undone.",
    cancel: "Cancel",
    ...
    exportTitle: "PetVitals data export",
  },
  de: {
    demoUser: "Demo-Benutzer",
    user: "PetVitals-Benutzer",
    ...
    deleteBody:
      "Ihr PetVitals-Konto und die zugehörigen Daten werden dauerhaft gelöscht. Dies kann nicht rückgängig gemacht werden.",
    cancel: "Abbrechen",
    ...
    metric: "Metrisch · kg",
    imperial: "Imperial · lb",
    exportTitle: "PetVitals-Datenexport",
  },
  es: {
    demoUser: "Usuario demo",
    user: "Usuario de PetVitals",
    ...
    deleteBody:
      "Tu cuenta de PetVitals y los datos relacionados se eliminarán de forma permanente. Esta acción no se puede deshacer.",
    cancel: "Cancelar",
    ...
    metric: "Métrico · kg",
    imperial: "Imperial · lb",
    exportTitle: "Exportación de datos de PetVitals",
  },
  ja: {
    demoUser: "デモユーザー",
    user: "PetVitalsユーザー",
    ...
    deleteBody:
      "PetVitalsアカウントと関連データは完全に削除されます。この操作は元に戻せません。",
    cancel: "キャンセル",
    delete: "アカウントを削除",
