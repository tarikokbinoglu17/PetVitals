...
const styles = StyleSheet.create({
  ...
  tabs: { ...shadow, backgroundColor: colors.surface, borderTopColor: colors.border, borderTopWidth: 1, flexDirection: 'row', paddingBottom: 12, paddingTop: 11 },
  tab: { alignItems: 'center', flex: 1, gap: 4, minHeight: 46, minWidth: 0, justifyContent: 'center' },
  icon: { color: colors.muted, fontSize: 19 },
  profileIcon: { alignItems: 'center', height: 22, justifyContent: 'center', width: 22 },
  profileHead: { backgroundColor: colors.muted, borderRadius: 4, height: 8, width: 8 },
  profileBody: { backgroundColor: colors.muted, borderTopLeftRadius: 8, borderTopRightRadius: 8, height: 8, marginTop: 2, width: 17 },
