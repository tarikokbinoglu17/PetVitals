...
const copy = {
  ...
  ja: {
    active: "Pawly Premiumは有効です", activeText: "AI、高度な分析、Premium共有機能を利用できます。", close: "閉じる", title: "よりスマートな健康管理。",
