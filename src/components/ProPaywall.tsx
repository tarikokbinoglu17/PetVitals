...
const copy = {
  tr: {
    active: "PetCookieGo Premium aktif",
    activeText:
  ...
  en: {
    active: "PetCookieGo Premium active",
    activeText:
  ...
  de: {
    active: "PetCookieGo Premium aktiv",
  ...
  es: {
    active: "PetCookieGo Premium activo",
    activeText:
  ...
  ja: {
    active: "PetCookieGo Premiumは有効です", activeText: "AI、高度な分析、Premium共有機能を利用できます。", close: "閉じる", title: "よりスマートな健康管理。",
